"""Maze game based off of dnd session
ask Malcolm for his map of the catacombs
potential fights
give spell slots equal to Seth, these act as resources, give life points
three layers of normal challenges ie pick right path to move on
fourth floor, very challenging puzzle, make professor mad when trying to play
through it
very unforgiving
